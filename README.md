...
-----------------------------------------------------------------
# CI/CD: Understanding Data Consumption
-----------------------------------------------------------------
About this Application Template:
This application template is designed to consume data via api 1 time per week - This can be adjusted
